...
encoder = joblib.load('encoder.pkl') #carregar o encoder
scaler = joblib.load('scaler.pkl')
kmeans = joblib.load('kmeans.pkl')

st.title('Grupos de interesse para marketing')
#write = escreve uma descrição
st.write("""
         ...
         """)
#botao que envia arquivo (necessita passar o valor de que tipo de arquivo será)
...
if(up_file is not None):
    ...
    df.insert(0,'grupos',cluster) #coluna_index,nome_coluna,dado
